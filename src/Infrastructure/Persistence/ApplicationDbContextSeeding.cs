...
namespace HikingTrailsApi.Infrastructure.Persistence
{
    public static class ApplicationDbContextSeeding
    {
        ...
        {
            var applicationDbContextFactory = serviceScope.ServiceProvider
                .GetService<IApplicationDbContextFactory<IApplicationDbContext>>();

            using var applicationDbContext = applicationDbContextFactory.CreateDbContext();
